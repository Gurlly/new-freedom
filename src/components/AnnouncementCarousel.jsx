  ...
  return (
    <>
      <div
        ...
        className="relative"
      >
        <div className="hs-carousel relative overflow-hidden w-full min-h-[26rem] md:h-[30rem] lg:h-[35rem] xl:h-[40rem] bg-white shadow shadow-neutral-600">
          <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
            ...
            <div className="hs-carousel-slide">
              <div className="w-full h-full announcement" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/drive-viewer/AKGpihZlkQKp-ePJ17nh_Bgm9AiXTG0CI0NJmoMIAvdfYXMTWjMBW4lDz7jiDpNzxZ9-ZyGuDWC8Te7aNv_3yhQ05L7HsL5WRIyOyA=s1600-rw-v1')"}}>
                <div className="w-full h-full p-2.5 backdrop-blur-[2px] flex flex-col items-center justify-center gap-y-3 lg:gap-y-56 tracking-tighter select-nont">
