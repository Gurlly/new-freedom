  ...
  return (
    <div className="App w-full h-full bg-freedom-white">
      <main className="w-full h-full">
          ...
          <nav className="md:container md:mx-auto">
            <div className="flex items-center justify-between">
              <img
                src={logo}
                alt="Freedom Logo"
                className="w-12 h-12 md:w-14 md:h-14 object-cover object-center user-select-none"
              />
              <button
                type="button"
              ...
              >
                {links.map((link, index) =>
                  link.id !== "form" ? (
                    <li key={index}>
                      <a
                        className={`hover:text-freedom-light-blue ${
                          link.active
                            ? "text-freedom-light-blue font-extrabold"
                            : "text-freedom-white font-bold"
                        } transition-colors ease-in-out delay-75 duration-200`}
                        href={`#${link.id}`}
                    ...
                    <li
                      className="hs-dropdown [--trigger:hover] relative inline-flex"
                      key={index}
                    >
                      <button
        ...
        <section
          id="hero"
          className="w-full h-dvh relative border border-freedom-gray"
        >
        ...
        <section
          id="about"
          className="w-full min-h-max px-5 py-20 md:px-10 md:py-24 lg:py-36 lg:px-14 xl:py-40 xl:px-32"
        >
          <div>
            <h1 className="font-extrabold tracking-widest text-[calc(2.5rem+2dvw)] mb-3 md:mb-7 lg:mb-10 xl:mb-14">
              WHO WE ARE?
            </h1>
            <p className="text-justify text-[calc(0.75rem+1dvw)]">
              At Freedom Christian Fellowship, we are a vibrant community
              dedicated to living out the teachings of Jesus Christ. Our goal is
              to create a welcoming environment where everyone can experience
              God's love and grace. We believe in the power of faith,
              fellowship, and service to transform lives and make a positive
              impact in our community and beyond.
              <br /> <br />
              Join us as we worship, grow, and serve together, building strong
              connections and supporting one another in our spiritual journeys.
              Whether you are new to faith or looking to deepen your
              relationship with God, you are welcome here.
            </p>
        ...
        <section id="event" className="w-full">
          ...
          <div className="w-full h-full py-20 md:py-24 lg:py-28">
        ...
        <section id="ministry" className="w-full bg-zinc-100">
          ...
          <div className="md:container md:mx-auto px-5 py-14 md:py-20 lg:py-24">
            <div className="w-full flex items-center justify-center mb-8 md:mb-10 lg:mb-14 xl:mb-24">
              <h1 className="text-[calc(2rem+2dvw)] font-extrabold tracking-tight">
                Ministries
              </h1>
            </div>
            <Ministry />
            ...
            <div className="md:container md:mx-auto px-5 py-8">
              <div className="font-semibold text-sm md:text-base text-freedom-white flex items-center justify-between gap-x-3">
                <h2 className="select-none">
                  © Freedom Christian Fellowship. All Rights Reserved.
                </h2>
                <div className="flex items-center gap-x-5 lg:gap-x-7 xl:gap-x-10">
                  <a
                    className="text-freedom-blue hover:text-blue-600 transition-colors ease-linear duration-200"
                    href="https://www.facebook.com/profile.php?id=100009815023687"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <FaFacebook size={27} />
                  ...
                  <a
                    className="text-gray-300 hover:text-gray-400 transition-colors ease-linear duration-200"
                    href="tel:+639969347564"
                  >
                    <FaPhoneAlt size={22} />
                  </a>
                </div>
